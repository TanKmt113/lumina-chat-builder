...
import { Bot, Send, X, MessageSquare, Loader2, Mic, MicOff, Volume2 } from 'lucide-react';
...
export default function WidgetPage() {
  ...
  if (!chatbot) return <div className="p-4 text-xs text-neutral-400">Widget not found</div>;

  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 p-2 flex flex-col items-end font-sans overflow-hidden pointer-events-none z-50">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-[350px] sm:w-[400px] h-[550px] sm:h-[600px] bg-white/95 backdrop-blur-2xl text-sm rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] border border-neutral-200/50 flex flex-col overflow-hidden mb-6 pointer-events-auto"
          >
            {/* Header */}
            ...
            >
              {messages.map((msg, i) => (
                ...
                >
                  ...
                  <div 
                    className={`max-w-[85%] p-3.5 px-4 text-[14.5px] leading-relaxed shadow-sm ${
                      msg.role === 'user' 
            ...
            <div className="p-4 bg-white/90 backdrop-blur-md border-t border-neutral-100">
              <div className="flex gap-2.5 items-center">
                ...
                <button 
                  ...
                  style={{ backgroundColor: chatbot?.primaryColor || '#000' }}
                >
      ...
      <motion.button
        ...
        className="w-16 h-16 rounded-full shadow-[0_10px_40px_-10px_rgba(0,0,0,0.4)] flex items-center justify-center text-white relative group border border-white/20 pointer-events-auto"
